...
const CIconfiguration = {
  ...
  'ChromeDev': {
    unitTest: {target: null, required: true},
    e2e: {target: null, required: true}
  },
  'FirefoxDev': {
    unitTest: {target: null, required: true},
  ...
  'IE9': {
    unitTest: {target: 'SL', required: false},
    e2e: {target: null, required: true}
  },
  'IE10': {
    unitTest: {target: 'SL', required: true},
  ...
  'Safari7': {
    unitTest: {target: 'BS', required: false},
    e2e: {target: null, required: true}
  },
  'Safari8': {
    unitTest: {target: 'BS', required: false},
  ...
  'iOS7': {
    unitTest: {target: 'BS', required: true},
    e2e: {target: null, required: true}
  },
  'iOS8': {
    unitTest: {target: 'BS', required: false},
  ...
  // TODO(mlaval): iOS9 deactivated as not reliable,
  // reactivate after https://github.com/angular/angular/issues/5408
  'iOS9': {
    unitTest: {target: null, required: false},
    e2e: {target: null, required: true}
  },
  'WindowsPhone': {
    unitTest: {target: 'BS', required: false},
...
const sauceAliases = {
  ...
  'MOBILE': ['SL_ANDROID4.1', 'SL_ANDROID4.2', 'SL_ANDROID4.3',
    'SL_ANDROID4.4', 'SL_ANDROID5', 'SL_IOS7', 'SL_IOS8', 'SL_IOS9'],
  'ANDROID': ['SL_ANDROID4.1', 'SL_ANDROID4.2', 'SL_ANDROID4.3',
    'SL_ANDROID4.4', 'SL_ANDROID5'],
